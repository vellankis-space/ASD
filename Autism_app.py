...
encoders_file = open("/Users/vellankisuryatejareddy/Desktop/Autism-Prediction/encoder.pkl",'rb')
encoders = pkl.load(encoders_file)

model_file = open("/Users/vellankisuryatejareddy/Desktop/Autism-Prediction/autism_model.pkl",'rb')
